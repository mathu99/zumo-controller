...
router.post('/contact', function (req, res) {
    ...
    const mailOptions = {
        ...
        html: `<div style="margin:0;padding:0" bgcolor="#FFFFFF"><table width="100%" height="100%" style="min-width:348px" border="0" cellspacing="0" cellpadding="0" lang="en"><tbody><tr height="32" style="height:32px"><td></td></tr><tr align="center"><td><table border="0" cellspacing="0" cellpadding="0"style="padding-bottom:20px;max-width:516px;min-width:220px"><tbody><tr><td width="8" style="width:8px"></td><td><div style="border-style:solid;border-width:thin;border-color:#dadce0;border-radius:8px;padding:40px 20px"align="center" class="m_6350944625218217992mdv2rw"><imgsrc="http://localhost:4200/assets/images/logo-dark-2.png" width="74"height="24" aria-hidden="true" style="margin-bottom:16px" alt="Focus"class="CToWUd"><divstyle="font-family:'Google Sans',Roboto,RobotoDraft,Helvetica,Arial,sans-serif;border-bottom:thin solid #dadce0;color:rgba(0,0,0,0.87);line-height:32px;padding-bottom:24px;text-align:center;word-break:break-word"><div style="font-size:24px">Your request has been submitted!</div><table align="center" style="margin-top:8px"><tbody><tr style="line-height:normal"><td align="right" style="padding-right:8px"></td><td><astyle="font-family:'Google Sans',Roboto,RobotoDraft,Helvetica,Arial,sans-serif;color:rgba(0,0,0,0.87);font-size:14px;line-height:20px">${contact.emailAddress}</a></td></tr></tbody></table></div><divstyle="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:14px;color:rgba(0,0,0,0.87);line-height:20px;padding-top:20px;text-align:left">Thanks for your submission via <a href="http://www.focus1.co.za"target="_blank">www.focus1.co.za</a>. We'll be in touch soon! Here's areview of your request:<table width="50%" height="100%" style="margin-top:32px; min-width:348px"border="0" cellspacing="0" cellpadding="0" lang="en"><tbody><tr><td style="font-weight: bold">Topic:</td><td>${contact.topic}</td></tr><tr><td style="font-weight: bold">Name:</td><td>${contact.name}</td></tr><tr><td style="font-weight: bold">Email:</td><td>${contact.emailAddress}</td></tr><tr><td style="font-weight: bold">Contact Number:</td><td>${contact.contactNumber}</td></tr></tbody></table><div style="padding-top:32px;text-align:center"><a target="_blank" href="http://focus1.co.za/" style="display: inline-block;font-weight: 400;color: #fff;background-color: #000;border-color: #000;text-align: center;vertical-align: middle;padding: 1rem 1.9rem;text-decoration:none;font-size: 1rem;line-height: 1.5;font-size: 0.75rem;letter-spacing: 0.86px;font-family: 'Google Sans',Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-weight: 700;border-radius: 5rem;">Visit Focus1</a></div></div></div><div style="text-align:left"><divstyle="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;color:rgba(0,0,0,0.54);font-size:11px;line-height:18px;padding-top:12px;text-align:center"><div>This is an informative message to notify you that we have recieved yourrequest and will process it as soon as we can.</div><div style="direction:ltr">© 2019 Focus1, <aclass="m_6350944625218217992afal"style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;color:rgba(0,0,0,0.54);font-size:11px;line-height:18px;padding-top:12px;text-align:center">252Rahima Moosa Street, Hillbrow, Johannesburg, 2001</a></div></div></div></td><td width="8" style="width:8px"></td></tr></tbody></table></td></tr><tr height="32" style="height:32px"><td></td></tr></tbody></table></div>`,
    };
